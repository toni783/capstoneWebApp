...
//gulp.task('serve', gulp.series('inject', 'watch', 'browsersync')); original
gulp.task('serve', gulp.series(['build'],'inject', 'watch', 'browsersync')); //modificado para hacer build antes de serve
